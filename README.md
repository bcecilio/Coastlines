...
What sets this application apart from other resources is its use of an AR feature. The goal is to provide a visual aid that will allow the user to see how sea level rise will progress from now until 2100. For now, only New York City supports the AR feature. In the later versions of the application, we would like to provide a model for each location featured in the app.  
